class Scene2 extends Phaser.Scene{
    ...
    create(){
        // https://phaser.discourse.group/t/facing-error-as-uncaught-typeerror-cannot-read-property-config-of-undefined/6574/10
        // config.width didn't work, had to use this.game before it
